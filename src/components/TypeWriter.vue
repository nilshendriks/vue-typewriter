<template>
  <div class="ce-typewriter">
    <div class="typewriter" :style="styling">
      <p class="typewriter__text" :style="textStyle" v-html="typeWriterValue"></p>
    </div>
  </div>
</template>
...
@font-face {
  ...
  src: url("./fonts/Impact_Label-webfont.woff") format("woff");
  font-weight: normal;
  font-style: normal;
  font-display: swap;
}
